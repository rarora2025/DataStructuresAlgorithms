...
def checkMyCode():
  ...
  moduleName = 'main'
  testFunction = 'radix'
  input1 = [[13, 1903, 2, 1903, 0],[1,243,83,654,35],[309,21,51,34,105],[3173,2010,2006,0,512,1024,88,64,843,6,1988, 2020]]
  expectedOutput = [[0,2,13,1903, 1903],[1,35,83,243,654],[21,34,51,105,309],[0,6,64,88,512,843,1024,1988,2006,2010,2020,3173]]
