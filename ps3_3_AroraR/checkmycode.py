...
def checkMyCode():
  ...
  print ("############################")
  print("")
  print ("##   Bubble SimulAssign   ##")
  print("")
  
  moduleName = 'main'
  testFunction = 'bubbleSort'
  input1 = [[13, 1903, 2, 1903, 0],[1,243,83,654,35],[309,21,51,34,105],[],[2],[2,1]]
  expectedOutput = [[0,2,13,1903, 1903],[1,35,83,243,654],[21,34,51,105,309],[],[2],[1,2]]
