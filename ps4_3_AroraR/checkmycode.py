...
def testMyDLList(thingToTest):
  dataType = 'DoublyList'
  print ("----------------------")
  print ("--- Starting Point ---")
  print ("----------------------")
  print ("__str__: %s" % (str(thingToTest)))
  print ("reverse_str(): %s" % ( thingToTest.reverse_str()))
  ...
  print ("reverse_str(): %s" % (thingToTest.reverse_str()))
  print ("%s size: %i" % (dataType, thingToTest.size()))
  testfunction(str(thingToTest), "[1, 3, 27, 4, 1]")
  testfunction(str(thingToTest.reverse_str()), "[1, 4, 27, 3, 1]")
  ...
  print ("----------------------")
  item = 4
  print ("Index of item '%i': %i" % (item, thingToTest.index_of(item)))
  print ("%s size: %i" % (dataType, thingToTest.size()))
  print ("%s: %s" % (dataType, str(thingToTest)))
  testfunction(thingToTest.index_of(item), 3)
  ...
  print ("%s size: %i" % (dataType, thingToTest.size()))
  print ("%s: %s" % (dataType, str(thingToTest)))
  testfunction(thingToTest.index_of(item), 2)
  ...
  print ("%s size: %i" % (dataType, thingToTest.size()))
  print ("%s: %s" % (dataType, str(thingToTest)))
  testfunction(thingToTest.index_of(item), 0)
  ...
  print ("__str__: %s" % (str(thingToTest)))
  print ("reverse_str(): %s" % ( thingToTest.reverse_str()))
  testfunction(str(thingToTest), "[3, 1]")
  ...
  print ("reverse_str(): %s" % ( thingToTest.reverse_str()))
  print ("%s size: %i" % (dataType, thingToTest.size()))
  testfunction(str(thingToTest), "[2, 3, 5, 17, 2]")
  ...
  print ("reverse_str(): %s" % ( thingToTest.reverse_str()))
  print ("%s size: %i" % (dataType, thingToTest.size()))
  testfunction(str(thingToTest), "[2, 3, 5, 17, 2, 5]")
  testfunction(str(thingToTest.reverse_str()), "[5, 2, 17, 5, 3, 2]")
  ...
  print ("__str__: %s" % (str(thingToTest)))
  print ("reverse_str(): %s" % ( thingToTest.reverse_str()))
  testfunction(str(thingToTest), "[3, 5, 17, 2, 5]")
  ...
  print ("__str__: %s" % (str(thingToTest)))
  print ("reverse_str(): %s" % ( thingToTest.reverse_str()))
  testfunction(str(thingToTest), "[5, 17, 2, 5]")
  ...
  print ("__str__: %s" % (str(thingToTest)))
  print ("reverse_str(): %s" % ( thingToTest.reverse_str()))
  testfunction(str(thingToTest), "[17, 2, 5]")
  ...
  print ("__str__: %s" % (str(thingToTest)))
  print ("reverse_str(): %s" % ( thingToTest.reverse_str()))
  testfunction(str(thingToTest), "[2, 5]")
  ...
  print ("__str__: %s" % (str(thingToTest)))
  print ("reverse_str(): %s" % ( thingToTest.reverse_str()))
  testfunction(str(thingToTest), "[4, 61, 28, 12, 50]")
  ...
  print ("__str__: %s" % (str(thingToTest)))
  print ("reverse_str(): %s" % ( thingToTest.reverse_str()))
  testfunction(str(thingToTest), "[4, 4, 61, 28, 12, 50]")
  ...
  index = 4
  print ("Item index: %i" % index)
  print ("Item Popped: %i" % thingToTest.pop(index))
  print ("%s size: %i" % (dataType, thingToTest.size()))
  print ("__str__: %s" % (str(thingToTest)))
  print ("reverse_str(): %s" % ( thingToTest.reverse_str()))
  testfunction(str(thingToTest), "[4, 4, 61, 28, 50]")
  ...
  print ("__str__: %s" % (str(thingToTest)))
  print ("reverse_str(): %s" % ( thingToTest.reverse_str()))
  testfunction(str(thingToTest), "[4, 4, 28, 50]")
  ...
  print ("__str__: %s" % (str(thingToTest)))
  print ("reverse_str(): %s" % ( thingToTest.reverse_str()))
  testfunction(str(thingToTest), "[4, 28, 50]")
  ...
  print ("__str__: %s" % (str(thingToTest)))
  print ("reverse_str(): %s" % ( thingToTest.reverse_str()))
  testfunction(str(thingToTest), "[4, 50]")
...
def checkMyCode():
  '''
  #If you are certain you have all the functions and they are correctly named, then
  #you may need to uncomment this section and comment the try and except instead.
  testMyUnorderedList(DoublyList())
  '''
  try:
    testMyDLList(DoublyList())
  except NameError:
    print("")
